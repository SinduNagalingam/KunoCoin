...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("18.179.58.104", true);
        vSeeds.emplace_back("13.230.26.48", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.kunocointools.com", true);
        vSeeds.emplace_back("seed-b.kunocoin.loshan.co.uk", true);
