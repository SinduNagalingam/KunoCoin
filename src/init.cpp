...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/kunocoin-project/kunocoin>";
    const std::string URL_WEBSITE = "<https://kunocoin.org>";
