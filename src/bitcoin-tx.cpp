...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s kunocoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  kunocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kunocoin transaction") + "\n" +
              "  kunocoin-tx [options] -create [commands]   " + _("Create hex-encoded kunocoin transaction") + "\n" +
              "\n";
