...
#if defined(NDEBUG)
# error "kunocoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "kunocoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s KUNO additional fees, %d delta bytes\n",
