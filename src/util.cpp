...
const char * const BITCOIN_CONF_FILENAME = "kunocoin.conf";
const char * const BITCOIN_PID_FILENAME = "kunocoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "kunocoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/kunocoin";
#else
    // Unix
    return pathRet / ".kunocoin";
#endif
#endif
}
